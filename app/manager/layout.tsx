...
export default function ManagerLayout({
  ...
  const navigation = [
    { name: 'Storage', href: '/manager/storage', icon: '📦' },
    { name: 'ID Management', href: '/manager/id-management', icon: '👥' },
    { name: 'Add Staff', href: '/manager/add-staff', icon: '➕' },
    { name: 'Shop Items', href: '/manager/shop-items', icon: '🛍️' },
    { name: 'Statistics', href: '/manager/statistics', icon: '📊' },
  ];

  return (
    <div className="manager-root flex h-screen bg-gray-100">
      {/* Sidebar */}
